defmodule GoFishTest do
  ...
  # setup do
  #   start_supervised!(GoFish.Ocean)
  #   start_supervised!(Supervisor.child_spec({GoFish.Player, {:john, true}}, id: :john))
  #   start_supervised!(Supervisor.child_spec({GoFish.Player, {:simon, true}}, id: :simon))
  # end
